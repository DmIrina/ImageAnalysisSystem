...
export default function ManipModule({results, originalFileName}) {
    ...
    return (
        <div>
            <h3 className="text-lg font-semibold mb-2">Перевірка маніпуляцій та редагування</h3>
            ...
            <p className="text-sm text-gray-600 mb-2">
                Модуль виявляє локальні втручання, наприклад зміна об’єктів на фото, видалення або додавання елементів, сильна ретуш шкіри, монтаж або композитинг.
