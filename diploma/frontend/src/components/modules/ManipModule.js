...
export default function ManipModule({results, originalFileName}) {
    ...
    return (
        <div>
            <h3 className="text-lg font-semibold mb-2">Аналіз маніпуляцій</h3>

            <p className="mb-2">
                Ймовірність втручання:
                <b> {manipScore != null ? `${(manipScore * 100).toFixed(2)}%` : "—"}</b>
            </p>

            <p className="text-sm text-gray-600 mb-2">
                Модуль аналізує структуру зображення для виявлення цифрових аномалій: вставки чужорідних об’єктів,
                видалення елементів або клонування областей.
            </p>

            <p className="text-sm text-gray-600 mb-2">
                На тепловій карті червоним кольором позначено ділянки, де виявлено сліди редагування.
                Чим насиченіший червоний колір — тим вища впевненість системи у факті підробки.
            </p>
