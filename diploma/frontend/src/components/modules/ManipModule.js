...
export default function ManipModule({ results, originalFileName }) {
    ...
    return (
        <div>
            <h3 className="text-lg font-semibold mb-2">Виявлення маніпуляцій (Photoshop / локальні зміни)</h3>

            <p className="mb-2">
                Ймовірність наявності маніпуляцій на зображенні:
                <b> {manipScore != null ? `${(manipScore * 100).toFixed(2)}%` : "—"}</b>
            </p>

            <p className="text-sm text-gray-600 mb-2">
                Модуль побудований на сегментаційній моделі (MVSS-Net++), яка виявляє
                локальні області редагування: вставки, композитинг, ретуш, сильне
                повторне стиснення тощо. Підсвічені ділянки на heatmap відповідають
                зонам з максимальною ймовірністю втручання.
            </p>
...
//     return (
//         <div>
//             <h3 className="text-lg font-semibold mb-2">Виявлення маніпуляцій (Photoshop)</h3>
//
//             <p className="mb-2">
//                 Ймовірність наявності маніпуляцій на зображенні:
//                 <b> {manipScore != null ? `${(manipScore * 100).toFixed(2)}%` : "—"}</b>
...
//
//             <p className="text-sm text-gray-600 mb-2">
//                 Цей модуль аналізує артефакти редагування (ConvNeXt) та повертає
//                 карту ділянок, де мережа «бачить» потенційні сліди обробки
//                 (стискання, ретуш, композитинг тощо).
//             </p>
//
//             {hasHeatmap ? (
//                 <div className="mt-3">
...
// import HeatmapCanvas from "../HeatmapCanvas";
//
// export default function ManipModule({ results }) {
//     const manipScore = results?.manipulation_score ?? null;
//     const manipHeatmap = results?.manip_heatmap ?? null;
//
//     const probText =
//         manipScore != null ? `${(manipScore * 100).toFixed(2)}%` : "—";
//
//     const hasHeatmap =
//         Array.isArray(manipHeatmap) &&
//         manipHeatmap.length > 0 &&
...
//     return (
//         <div>
//             <h3 className="text-lg font-semibold mb-2">Детекція маніпуляцій (Photoshop)</h3>
//
//             <p className="mb-3">
//                 Ймовірність наявності маніпуляцій / фотомонтажу:{" "}
//                 <b>{probText}</b>
//             </p>
//
//             <p className="text-sm text-gray-600 mb-2">
//                 Цей модуль аналізує артефакти редагування (ConvNeXt) та
//                 повертає карту ділянок, де мережа "бачить" потенційні
//                 сліди обробки.
//             </p>
//
//             {hasHeatmap ? (
...
//                         Heatmap підозрілих ділянок (маніпуляції):
//                     </p>
//                     <HeatmapCanvas
//                         data={manipHeatmap}
//                         width={256}
...
//             ) : (
//                 <p className="text-sm text-gray-500 mt-2">
//                     Heatmap для маніпуляцій відсутній.
//                 </p>
//             )}
//         </div>
//     );
