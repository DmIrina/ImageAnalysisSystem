...
def train_one(model,
    ...
    """
    Універсальний цикл навчання з early stopping по val_acc.
    Якщо val_acc не покращується 'patience' епох — зупиняємося.

    class_weights:
      - None  → звичайний CrossEntropyLoss
      - tensor довжини C → зважена функція втрат (важливо для балансу класів)
    """
...
def load_or_train(model_name,
    ...
    if classes is None:
        # fallback: позитивний клас у бінарній задачі = індекс 1
        pos_idx = 1
    else:
...
def compute_binary_metrics(
    ...
    y_true: масив 0/1 (1 – позитивний клас)
    y_prob: масив [0..1] – ймовірність позитивного класу
    """
